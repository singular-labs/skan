...
- [2 - Conversion Value Management](#a3)
	- [2.1 - Introduction to Conversion Value Management](#a3.1)
	- [2.2 - Existing Limitations](#a3.2)
	- [2.3 - Intelligent conversion value management](#a3.3)
	- [2.4 - Conversion value management data flow](#a3.4)
	- [2.5 - Supported models](#a3.5)
	- [2.6 - Frequency of conversion value updates](#a3.6)
	- [2.7 - Max duration of conversion value](#a3.7)
- [3. SKAN Campaign ID Management](#a4)
	- [3.1 - Background](#a4.1)
	- [3.2 - Mapping API](#a4.2)
- [4 - Secure Data Flow](#a2)
	- [4.1 - Background](#a2.1)
	- [4.2 - List of Secure Ad Networks](#a2.2)
	- [4.3 - Secure Data Flow Diagram](#a2.3)
	- [4.4 - Detailed Data Flow](#a2.4)
